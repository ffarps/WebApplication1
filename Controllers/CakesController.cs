...
namespace WebApplication1.Controllers
{
    public class CakesController : Controller
    {
        ...
        public CakesController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cake != null ? 
                          ...
                          Problem("Entity set 'WebApplication1Context.Cake'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplication1Context.Cake'  is null.");
            }
            var cake = await _context.Cake.FindAsync(id);
            if (cake != null)
            {
